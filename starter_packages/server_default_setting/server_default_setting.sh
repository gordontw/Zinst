...
checkDIR=`ls $ZinstDir/z/ |grep sbin`
	...
	if [[ $checkDIR = "" ]]
	then
		sudo rm -f $ZinstDir/z/usr $ZinstDir/z/etc $ZinstDir/z/var $ZinstDir/z/bin $ZinstDir/z/sbin $ZinstDir/z/lib64 $ZinstDir/z/home $ZinstDir/z/source $ZinstDir/z/instances $ZinstDir/z/applications 1> /dev/null
